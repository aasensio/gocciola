...
!-----------------------------------------------------------------
	subroutine background_opacity(T, Pe, PH, PHminus, PHplus, PH2, PH2plus, lambda_in, chi, chis)
	real(kind=8) :: T, Pe, PH, PHminus, PHplus, PH2, PH2plus, lambda_in, chi, chis
	real(kind=8) :: factor
	real(kind=8) :: contrib1, contrib2, contrib3, contrib4, contrib5, contrib6, contrib7
...
! because nH*factor=nH_tot
		...
		chi = PH / (PK*T) * &
			(contrib1 + contrib2 + contrib3 + contrib4 + contrib7)
		chis = PH / (PK*T) * &
			(contrib5 + contrib6)		
				
	end subroutine background_opacity	
