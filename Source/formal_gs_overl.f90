...
!-----------------------------------------------------------------
	subroutine formal_solver_gs_overlap(which)
...
! Make a formal solution of RTE using GS or SOR (population changes are made inside)		
		call rtspher_gs_overlap(n_radios,which)	

	end subroutine formal_solver_gs_overlap
...
!-----------------------------------------------------------------------	
	...
	subroutine rtspher_gs_overlap(np,which)
...
! intensities to this point before going out. Only if the true GS iteration is being used
	...
	end subroutine rtspher_gs_overlap
end module formal_gs_overlap
